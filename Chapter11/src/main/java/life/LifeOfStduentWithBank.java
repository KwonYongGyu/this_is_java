...
public class LifeOfStduentWithBank {
	...
	public void doToday() {
		...
		com.mjc813.life.StudentHasBankAccount lshBank = new com.mjc813.life.StudentHasBankAccount(lsh, ba1);
		com.mjc813.life.StudentHasBankAccount cwcBank = new com.mjc813.life.StudentHasBankAccount(cwc, ba2);

		this.sendMoney(lshBank, cwcBank, 100000);
		this.sendMoney(cwcBank, lshBank, 5000);
	}

	public void sendMoney(com.mjc813.life.StudentHasBankAccount from, StudentHasBankAccount to, int money) {
